...
const Listofproducts = () => {
  ...
  const initialProducts = [
    {
      productImg:
        "https://res.cloudinary.com/drqiw6wyl/image/upload/v1725859683/toordal_tedikn.jpg",
      productName: "ToorDal",
      price: "130",
      units: "150 KG",
      isOrganic: true,
      ...
      validity: "2025-12-31",
      description:
        "A perennial legume that belongs to the Fabaceae family, which is also known as pigeon pea or split pigeon pea, arhar dal or red gram dal",
      packaging: { "1 KG": 2, "5 KG": 10 },
    },
    {
      productImg:
        "https://res.cloudinary.com/drqiw6wyl/image/upload/v1725859683/2k660c8g_green-moong_625x300_12_July_23_cddszi.jpg",
      ...
      validity: "2024-06-30",
      description:
        "The split version of whole mung beans also known as green gram (with skin).",
  ...
  return (
    <>
      <h2 className="title"> Products from {seller?.Name}</h2>
      <Row gutter={16}>
